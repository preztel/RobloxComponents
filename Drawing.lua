...
getgenv().CreateRenderObject = getupvalue(Drawing.new, 1) ~= nil and getupvalue(Drawing.new, 1) or Drawing.new
getgenv().SetRenderProperty = setrenderproperty or getupvalue(getupvalue(Drawing.new, 7).__newindex, 4)
getgenv().GetRenderProperty = getrenderproperty or getupvalue(getupvalue(Drawing.new, 7).__index, 4)
getgenv().DestroyRenderObject = getupvalue(getupvalue(Drawing.new, 7).__index, 3) ~= nil and getupvalue(getupvalue(Drawing.new, 7).__index, 3) or Drawing.Remove
